        ...
        {visible.map((area) => (
          <li key={area.slug}>
            <Link
              ...
              className="block rounded-lg border border-neutral-200 px-3 py-2.5 text-sm text-brand-700 transition hover:border-accent-500 hover:bg-neutral-100 hover:text-brand-900"
            >
              {area.name}
            </Link>
          </li>
